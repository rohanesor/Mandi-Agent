...
SHELF_LIFE_DATABASE: list[dict[str, Any]] = [
    {
        "commodity": "tomato",
        "min_shelf_life_hours": 48,
        "max_shelf_life_hours": 96,
        "optimal_temp_celsius": 12,
        "optimal_humidity_pct": 85,
        "storage_tips": "Store at 10-15°C. Do not refrigerate below 10°C. Keep away from direct sunlight.",
    },
    {
        "commodity": "onion",
        "min_shelf_life_hours": 120,
        "max_shelf_life_hours": 240,
        "optimal_temp_celsius": 0,
        "optimal_humidity_pct": 65,
        "storage_tips": "Store in cool, dry, well-ventilated area. Do not refrigerate.",
    },
    {
        "commodity": "potato",
        "min_shelf_life_hours": 168,
        "max_shelf_life_hours": 504,
        "optimal_temp_celsius": 8,
        "optimal_humidity_pct": 85,
        "storage_tips": "Store in dark, cool place. Light turns potatoes green and toxic.",
    },
    {
        "commodity": "mango",
        "min_shelf_life_hours": 36,
        "max_shelf_life_hours": 72,
        "optimal_temp_celsius": 13,
        "optimal_humidity_pct": 85,
    ...
    },
    {
        ...
        "min_shelf_life_hours": 24,
        "max_shelf_life_hours": 48,
        "optimal_temp_celsius": 0,
        "optimal_humidity_pct": 90,
    ...
    {
        "commodity": "cabbage",
        "min_shelf_life_hours": 72,
        "max_shelf_life_hours": 144,
        "optimal_temp_celsius": 0,
        "optimal_humidity_pct": 90,
    ...
    },
    {
        ...
        "min_shelf_life_hours": 48,
        "max_shelf_life_hours": 72,
        "optimal_temp_celsius": 10,
        "optimal_humidity_pct": 80,
        "storage_tips": "Do not refrigerate below 10°C. Store at room temperature.",
    },
    {
        "commodity": "green_peas",
        "min_shelf_life_hours": 12,
        "max_shelf_life_hours": 36,
        "optimal_temp_celsius": 0,
        "optimal_humidity_pct": 90,
    ...
    {
        "commodity": "spinach",
        "min_shelf_life_hours": 6,
        "max_shelf_life_hours": 18,
        "optimal_temp_celsius": 0,
    ...
    {
        "commodity": "carrot",
        "min_shelf_life_hours": 96,
        "max_shelf_life_hours": 168,
        "optimal_temp_celsius": 0,
        "optimal_humidity_pct": 90,
    ...
    },
    {
        ...
        "max_shelf_life_hours": 168,
        "optimal_temp_celsius": 12,
        "optimal_humidity_pct": 70,
        "storage_tips": "Store in refrigerator or freeze for longer storage.",
    },
    {
        "commodity": "turmeric",
        "min_shelf_life_hours": 720,
        "max_shelf_life_hours": 1440,
        "optimal_temp_celsius": 25,
        "optimal_humidity_pct": 60,
    ...
    },
    {
        ...
        "min_shelf_life_hours": 168,
        "max_shelf_life_hours": 336,
        "optimal_temp_celsius": 5,
        "optimal_humidity_pct": 85,
    ...
    {
        "commodity": "wheat",
        "min_shelf_life_hours": 8760,
        "max_shelf_life_hours": 26280,
        "optimal_temp_celsius": 20,
        "optimal_humidity_pct": 65,
...
class RAGIngestionPipeline:
    ...
    def _chunk_agmarknet_row(self, row: dict[str, Any]) -> dict[str, Any] | None:
        """
    ...
    async def ingest_kvk_advisories(
        ...
        if advisory_dir:
            ...
            for filename in os.listdir(advisory_dir):
                ...
                chunk_content = (
                    f"Crop: {crop.title()}. District: {district.title()}. Season: {season.title()}. Advisory: {content}"
                )
    ...
    async def ingest_icar_shelf_life(self) -> IngestionStats:
        ...
        logger.info("Created %d shelf life chunks from %d entries", len(chunks), len(SHELF_LIFE_DATABASE))
    ...
    async def ingest_all(
        self,
        agmarknet_csv: str | None = None,
        advisory_dir: str | None = None,
        agmarknet_limit: int | None = None,
    ) -> list[IngestionStats]:
        """
